...
<meta charset="ISO-8859-1">
 <title>View Course Instructor</title>
 ...
 <tbody>
        <tr>
                ...
                try{
              	...
              	st=conn.prepareStatement("select * from course_instructor");
                    ...
                    while(rs.next())
                    {
                        ...
                        <td><%=rs.getString("course_numb")%></td>
                        <td><%=rs.getString("course_instructor")%></td></tr>
