...
try{
	...
	statement.executeUpdate("INSERT INTO dept_course (dept_name,course_numb) SELECT '"+Dname+"','"+CId+"' WHERE NOT EXISTS (Select dept_name,course_numb From dept_course WHERE dept_name='"+Dname+"' AND course_numb='"+CId+"') LIMIT 1 ");
	...
	out.println("Please enter valid course id or department name!");
}
%>
    <!--Header Start-->
    <section id="header">
...
<div class="menu-bar">
    ...
    <section id="background">
     ...
     <h2>Add Department Course</h2>
       ...
       <input type="text"  name="Did" placeholder="Department Name" required>  
